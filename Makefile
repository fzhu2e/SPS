...
SRCS =	sp_dynamic.f90 sp_module_advection.f90 sp_module_boundary.f90 \
	sp_module_constant.f90 sp_module_debug.f90 sp_module_gridvar.f90 \
	sp_module_initiate.f90 sp_module_integrate.f90 \
	sp_module_interpolate.f90 sp_module_model.f90 sp_module_output.f90 \
	sp_module_physics.f90 sp_module_tendency.f90 \
...
OBJS =	sp_dynamic.o sp_module_advection.o sp_module_boundary.o \
	...
	sp_module_initiate.o sp_module_integrate.o sp_module_interpolate.o \
	sp_module_model.o sp_module_output.o sp_module_physics.o \
	sp_module_tendency.o sp_module_timeschemes.o
...
sp_module_integrate.o: sp_module_boundary.o sp_module_constant.o \
	...
	sp_module_physics.o sp_module_timeschemes.o
...
sp_module_physics.o: sp_module_constant.o sp_module_debug.o \
	sp_module_gridvar.o sp_module_model.o
