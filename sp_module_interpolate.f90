...
!CALL w2pi(theta_0,theta_0_pi)
!CALL w2u(theta_0,theta_0_u)
!CALL w2vir(theta_0,theta_0_vir)

CALL w2pi(theta_1,theta_1_pi)
CALL w2u(theta_1,theta_1_u)
CALL w2vir(theta_1,theta_1_vir)

!CALL pi2u(rho_0,rho_0_u)
!CALL pi2w(rho_0,rho_0_w)
!CALL pi2vir(rho_0,rho_0_vir)
